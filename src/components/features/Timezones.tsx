  ...
  return (
    <div>
      <div className="timezone-btns">
        <div className="bg-light rounded"><b>PST :</b> {timeByZones.PST}</div>
        <div className="bg-light rounded"><b>CST :</b> {timeByZones.CST}</div>
        <div className="bg-light rounded"><b>EST :</b> {timeByZones.EST}</div>
      </div>
      <div className="timezone-ist-btn">
        <div className="bg-info rounded"><b>IST :</b> {timeByZones.IST}</div>
      </div>
    </div>
  );
};
